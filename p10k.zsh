# Generated by Powerlevel10k configuration wizard on 2025-03-14 at 19:36 WET.
...
# lightest-ornaments, compact, concise, transient_prompt, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    time                    # current time
    # =========================[ Line #2 ]=========================
    # newline (disabled for single-line prompt)
